  ...
  return (
    <section>
      <div className="page-header">
        ...
        <div className="header-actions">
          <button type="button" className="secondary-button" onClick={() => setShowJudgingGuide(true)}>
            ...
            <article className="tally-card" key={tally.category.id}>
              ...
              <section className="tally-section">
                ...
                {canManage && tally.judgeRanking.length >= 3 ? (
                  <button type="button" className="secondary-button compact-button" onClick={() => setManualCategory(tally)}>
                    Finalize Winners
                  </button>
                ) : null}
      ...
      {selectedWinner ? (
        <WinnerDrawer registration={selectedWinner} onClose={() => setSelectedWinner(null)} />
      ) : null}
      {manualCategory ? (
        <ManualWinnersDrawer
    ...
    <div className="drawer-backdrop" role="presentation">
      <aside className="winner-drawer" aria-label="Judging ranking process">
        <div className="drawer-header">
          ...
          <button type="button" className="icon-button light" onClick={onClose} aria-label="Close judging rules">
            <X size={20} />
          </button>
        </div>
        ...
        <div className="guide-section">
          <h3>Judge Ballots</h3>
          <ul>
            <li>Each judge ranks up to 10 vehicles in each category.</li>
            <li>Rank 1 is the strongest judge selection.</li>
            <li>Rank 10 is still counted, but carries the fewest points.</li>
          </ul>
        </div>
        ...
        <div className="guide-section">
          ...
          <ul>
            ...
            <li>Scoring continues down to 10th place = 1 point.</li>
          </ul>
        </div>
        ...
        <div className="guide-section">
          <h3>Tie Breaks</h3>
          <ul>
            <li>Highest total judge points wins.</li>
            <li>If tied, the vehicle with more judge first-place rankings wins.</li>
            <li>If still tied, People's Choice top-10 tie-break points are used.</li>
            <li>If still tied, judge second-place counts are compared, then third-place counts, down through tenth.</li>
            <li>If still tied, an admin manually finalizes the category order.</li>
          </ul>
        </div>

        <div className="guide-section">
          <h3>People's Choice Tie-Break Points</h3>
          <ul>
            <li>People's Choice 1st place = 10 tie-break points.</li>
            <li>People's Choice 2nd place = 9 tie-break points.</li>
            <li>Scoring continues down to People's Choice 10th place = 1 tie-break point.</li>
            <li>People's Choice only affects judged awards when a judge-score tie needs to be broken.</li>
          </ul>
        </div>
      </aside>
    </div>
...
function ManualWinnersDrawer({
  ...
  const [winnerIds, setWinnerIds] = useState(() =>
    [1, 2, 3].map((rank) => tally.judgeTop3.find((winner) => winner.rank === rank)?.registration.id ?? candidates[rank - 1]?.registration.id ?? ""),
  );
    ...
    <div className="drawer-backdrop" role="presentation">
      <aside className="winner-drawer" aria-label="Manual winner order">
        <div className="drawer-header">
          ...
          <button type="button" className="icon-button light" onClick={onClose} aria-label="Close manual winner order">
            <X size={20} />
          </button>
        </div>

        <div className="alert">{tally.judgingDescription}</div>
        ...
        <div className="manual-winner-form">
          ...
          {uniqueWinnerCount !== 3 ? <div className="alert danger">Choose three different vehicles.</div> : null}
          <button
            type="button"
    ...
    <div className="drawer-backdrop" role="presentation">
      <aside className="winner-drawer" aria-label="Winner vehicle details">
        <div className="drawer-header">
          ...
          <button type="button" className="icon-button light" onClick={onClose} aria-label="Close winner details">
            <X size={20} />
          </button>
        </div>
